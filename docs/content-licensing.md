...
| `items.json` | Golden weapons/armor/spellbook plus Batches 16–17 simple and martial light/one-handed weapons: pounds and documentary combat fields. Remaining two-handed/exotic weapons and armor are queued (pack design §7); magic items are not in this folder yet |
