...
| `items.json` | Golden weapons/armor/spellbook plus Batch 16 simple melee/ranged/ammo: pounds and documentary combat fields. Remaining martial/exotic weapons and armor are queued (pack design §7); magic items are not in this folder yet |
