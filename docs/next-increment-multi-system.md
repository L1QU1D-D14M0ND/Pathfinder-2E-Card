...
| Finish First Edition (CRB fill-out, APG follow-through) | **Next** (Batches 16–19 weapons landed; W1 reach on an N-tag `weapon.properties` list; next is W2 brace, then remaining Specials, then armor) |
