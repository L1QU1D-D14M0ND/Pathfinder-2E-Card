...
| Finish First Edition (CRB fill-out, APG follow-through) | **Next** (Batches 16–19 weapons landed; W1–W2 reach/brace on an N-tag `weapon.properties` list; next is W3 trip, then remaining Specials, then armor) |
