...
**Status:** Active sequencing document (2026-08-27)  
...
| Content | `content/pf1e/crb/` batches 1–15. `content/pf1e/apg/` Synthesist + golden. Spanish UI catalog landed |
...
| Finish First Edition (CRB fill-out, APG follow-through) | **Next** (Batch 15 spells-per-day landed; next is remaining catalog rows) |
