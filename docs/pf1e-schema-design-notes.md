...
7. Phase 3c CRB pack in batches of two mechanics ([`pf1e-crb-pack-design.md`](pf1e-crb-pack-design.md)). Batches 1–6 and 8–10 landed. **Next: remaining 9 CRB classes.**
