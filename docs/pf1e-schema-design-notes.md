...
7. Phase 3c CRB pack in batches of two mechanics ([`pf1e-crb-pack-design.md`](pf1e-crb-pack-design.md)). Batches 1–13 landed (including Batch 7). Draft + PWA proof landed. **Next: OGL review, then 1.0 Synthesist.** **1.0:** playable APG Synthesist Summoner (not the CRB pack).
