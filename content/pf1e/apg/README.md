...
See [`docs/pf1e-apg-pack-design.md`](../../../docs/pf1e-apg-pack-design.md). **Next:** documentary evolution names + fused overlay (still not auto-applied). Spanish is a separate 1.0 track.
