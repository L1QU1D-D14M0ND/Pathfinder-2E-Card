...
See [`docs/pf1e-apg-pack-design.md`](../../../docs/pf1e-apg-pack-design.md). **1.0 landed.** Next product work is honesty/code fixes on the sheet, then remaining CRB feats/spells, then Summoner spell catalog and other APG slices — not leftover PF2e. Synthesist golden: [`fixtures/characters/golden/pf1e/synthesist-5.json`](../../../fixtures/characters/golden/pf1e/synthesist-5.json). Evolutions are still not auto-applied. Spanish UI is `app/src/locales/es.json`, not this folder.
