...
See [`docs/pf1e-crb-pack-design.md`](../../../docs/pf1e-crb-pack-design.md) for the review process and landed batches (1–15, including Batch 7). APG Summoner lives in [`../apg/`](../apg/). **Never** add `class.summoner` here.
