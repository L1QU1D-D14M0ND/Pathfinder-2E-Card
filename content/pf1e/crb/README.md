...
| `items.json` | Item **id, name, pounds**, plus documentary weapon/armor stats. Batch 10: golden weapons, armor, and spellbook. Batches 16–21: remaining mundane CRB weapons, armor, and shields ([pack design §7](../../../docs/pf1e-crb-pack-design.md)). Magic weapons/armor later. Combat numbers stay on `armorClass` / `attacks`. |
...
See [`docs/pf1e-crb-pack-design.md`](../../../docs/pf1e-crb-pack-design.md) for the review process, landed batches (1–14, including Batch 7), and the mundane equipment fill-out queue (16–21). APG Summoner lives in [`../apg/`](../apg/). **Never** add `class.summoner` here.
