...
See [`docs/pf1e-crb-pack-design.md`](../../../docs/pf1e-crb-pack-design.md) for the review process, landed batches (1–14, 16–19, and W1, including Batch 7), and the remaining mundane equipment queue (W2–W7 then 20–21). `weapon.properties` is a **list of N tags** (one is valid; many are valid; later magic properties use the same entry). APG Summoner lives in [`../apg/`](../apg/). **Never** add `class.summoner` here.
