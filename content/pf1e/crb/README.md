...
See [`docs/pf1e-crb-pack-design.md`](../../../docs/pf1e-crb-pack-design.md) for the review process and landed batches (1–13, including Batch 7). **Next is OGL review then 1.0**, not more CRB encyclopedia rows. APG Synthesist Summoner is a **1.0** bar, not this CRB folder.
