...
| `items.json` | Item **id, name, pounds**, plus documentary weapon/armor stats. Batch 10 goldens. Batch 16: remaining simple melee/ranged and simple ammo. Batch 17: martial light + remaining martial one-handed. Batches 18–21: remaining two-handed/exotic weapons, armor, and shields ([pack design §7](../../../docs/pf1e-crb-pack-design.md)). Magic weapons/armor later. Combat numbers stay on `armorClass` / `attacks`. |
...
See [`docs/pf1e-crb-pack-design.md`](../../../docs/pf1e-crb-pack-design.md) for the review process, landed batches (1–14 and 16–17, including Batch 7), and the remaining mundane equipment queue (18–21). APG Summoner lives in [`../apg/`](../apg/). **Never** add `class.summoner` here.
