...
**Current phase:** 1 of 5 — character schema v1 and a React spreadsheet scaffold are in the repo. Core calc engine, Player Core content packs, golden tests, and i18n catalogs are not started. See [design doc §11](docs/pf2e-dynamic-character-sheet-design.md#11-phased-delivery) and [continuation options](docs/continuation-design.md).
